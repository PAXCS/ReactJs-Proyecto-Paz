    ...
    const myPromise = new Promise((resolve, reject) => {
        const productList = [
            {id: 1,
             ...
             stock: 20,
             price: 75000, 
             pictureUrl: 'https://http2.mlstatic.com/D_NQ_NP_2X_966955-MLA48579050616_122021-F.webp', 
             detail:'Samsung presenta su equipo Galaxy A52s potenciado con tecnología 5G, pantalla AMOLED de 6.5 pulgadas y un modulo de cuatro cámaras, siendo la principal de 64MP para capturar bellos momentos.'},
            {id: 2, 
            title: 'Notebook',
            stock: 10,
            price: 150000, 
            pictureUrl:'https://http2.mlstatic.com/D_NQ_NP_908593-MLA49420869607_032022-O.webp', 
            ...
            stock: 15,
            price: 65000, 
            pictureUrl:'https://http2.mlstatic.com/D_NQ_NP_2X_909806-MLA47146793018_082021-F.webp', 
            ...
            stock: 5,
            price: 120000, 
            pictureUrl:'https://http2.mlstatic.com/D_NQ_NP_2X_974663-MLA47846000904_102021-F.webp', 
